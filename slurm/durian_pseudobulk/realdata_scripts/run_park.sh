...
# ursm params
######################################################################################
# export number_of_cell_types=11 # for gupta is 11, for baron is 14, for park is 14
export number_of_cell_types=14 # for gupta is 11, for baron is 14, for park is 14
...
TypeList=( "" )
export SCDATADIR=$PROJECTDIR/slurm/Park/durian_data
export SCPREFIX="ParkWT.VST1K05_"
...
for SUBSETCELLTYPES in "${TypeList[@]}"; do
        for LAMBDA in "${LAMBDAS[@]}"; do
                ...
                export DurianGamma
                export LAMBDA
                export OUTPUTMASTER=$BASEDIR/durian_pseudobulk/output/durian_pseudobulk_$suffix/output.final.park,n_$NSIM
