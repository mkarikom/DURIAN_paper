...
dropout_mid = as.numeric(strsplit(Sys.getenv("dropMids"),":")[[1]])
dropout_shape = as.numeric(strsplit(Sys.getenv("dropShapes"),":")[[1]])
...
print(paste0("len dmid",length(dropout_mid)))
print(paste0("len dshape",length(dropout_shape)))
### output
