...
TypeList=( "" )
PREFIXTUPLES=( "HeSC.LS.sense01.cpm1K05;SuarezLS.sense0.1.cpm" "HeSC.NL.sense01.cpm1K05;SuarezNL.sense0.1.cpm" "HeSC.LS.cpm1K05;SuarezLS.cpm" "HeSC.NL.cpm1K05;SuarezNL.cpm" )
...
# ursm params
######################################################################################
export number_of_cell_types=8 # for gupta is 11, for baron is 14, for he is 8
